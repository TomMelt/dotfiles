...
"Compile pdfLatex
nnoremap <buffer> <F5> :w<CR> :!clear<CR> :!pdflatex "%" <Bar> grep -i warning<CR> <C-L> 2h
inoremap <buffer> <F5> <Esc>:w<CR> :!clear<CR> :!pdflatex "%" <Bar> grep -i warning<CR> <C-L> hi

"Compile pdfLatex with BibTex
nnoremap <buffer> <F4> :w<CR> :!pdflatex "%" > /dev/null<CR> :!clear<CR> :!bibtex "%:r" <Bar> grep -i warning<CR> :!pdflatex "%" > /dev/null<CR> :!pdflatex "%" <Bar> grep -i warning<CR> :redraw!<CR> 2h
inoremap <buffer> <F4> <Esc>:w<CR> :!pdflatex "%" > /dev/null<CR> :!clear<CR> :!bibtex "%:r" <Bar> grep -i warning<CR> :!pdflatex "%" > /dev/null<CR> :!pdflatex "%" <Bar> grep -i warning<CR> :redraw!<CR> hi
...
inoremap <buffer> <localleader>rf \ref{fig_} (<>)<Esc>F_a
